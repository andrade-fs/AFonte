...
import { FacebookLogo, InstagramLogo, TwitterLogo, WhatsappLogo } from "@phosphor-icons/react"
        ...
        <footer className="w-full flex flex-col bg-white">
            <section className="w-full h-auto grid lg:grid-cols-5 md:grid-cols-3 lg:px-20 md:px-12 px-6 py-16 gap-7 md:gap-4 lg:gap-0">
                <div className="flex flex-col items-start gap-4">
                    <Image className="w-48" image={logo} alt="Logo" as="a" href="/" />
                ...
                <div className="flex flex-col lg:items-center w-full md:mt-8 gap-4">
                    <ul className="w-full flex items-center lg:justify-center gap-4">
                        ...
                        <List>
                            <Link to={`https://wa.me/628 56 63 88?text=Hola!%20Quiero%20reserver%20una%20mesa%20para%20desayunar%20ma%C3%B1ana%20%F0%9F%98%8A`} className="text-color3 border-[1px] border-color3/50 p-2.5 flex rounded-full transition-all duration-300 ease-in hover:bg-gradient-to-tr from-color1 to-color2 hover:text-white">
            ...
            <Text className="text-center bg-color4 text-white text-xs py-6 font-light">
                Copyright 2023. afontecafe.com. All rights reserved.
            </Text>
        </footer>
    )
}
